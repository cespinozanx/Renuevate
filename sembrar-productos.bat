...
REM      catalogo de Renuevate (Nacar: 7 productos reales con foto, precio e
REM      ingredientes verdaderos -- incluye NACAR-11/12 de Maquillaje, Fix 84;
REM      Vigor, Roble + accesorios), y
